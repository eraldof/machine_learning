...
## Avaliando o modelo no conjunto teste e selecionando o melhor baseando-se no menor EQM.
```{r}
teste_svm$.metrics
teste_knn$.metrics
teste_elastic$.metrics
```
...
## Por fim os valores preditos vs o real

```{r}
yhat <- predict(wf_final, data)
