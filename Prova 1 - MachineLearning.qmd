...
`resposta:` Escolheria o modelo de Regressão Elastic pelo fato da raiz quadrada do erro quadrado médio ser o menor entre os 3 modelos anteriores. Além disso, ele foi o que mais rápido se ajustou aos dados. 